...
class Admin::WebsitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_website" do
    assert_difference("Admin::Website.count") do
      post admin_websites_url, params: { admin_website: { content_data: @admin_website.content_data, name: @admin_website.name, subdomain: @admin_website.subdomain, theme_id: @admin_website.theme_id, user_id: @admin_website.user_id } }
    end
  ...
  test "should update admin_website" do
    patch admin_website_url(@admin_website), params: { admin_website: { content_data: @admin_website.content_data, name: @admin_website.name, subdomain: @admin_website.subdomain, theme_id: @admin_website.theme_id, user_id: @admin_website.user_id } }
